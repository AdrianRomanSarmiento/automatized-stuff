...
#            rotation2 - Rotates 90, 180 or 270 degrees (clockwise) a specific page of a PDF. The output file is the original file but with the rotated page in the same position.
